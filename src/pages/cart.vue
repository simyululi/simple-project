...
import { checkCart, _getCartList, _delProduct, _updateCart } from "@/api";
...
export default {
  ...
  methods:{
    ...
    updateCart(item,type){
      ...
      _updateCart(item, quantity, selected).then((res)=>{
        this.renderData(res);
      })
    },
    // 删除购物车商品
    delProduct(item){
      _delProduct(item).then((res)=>{
        this.renderData(res);
      });
    },
    // 控制全选功能
